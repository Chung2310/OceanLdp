          ...
          <div className="bg-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-sm text-sm text-slate-700 leading-relaxed space-y-4">
            {activeTab === 'payment' && (
              <div className="space-y-4">
                ...
                <p>Học viên đăng ký khóa học tại Thanhmaihsk có thể thanh toán học phí qua các hình thức sau:</p>
                <ul className="space-y-2 list-disc pl-5">
                  <li><strong>Chuyển khoản Ngân hàng:</strong> Quét mã VietQR chuyển khoản vào tài khoản Công ty TNHH Phát triển Giáo dục và Hợp tác Quốc tế Thanhmaihsk.</li>
                  <li><strong>Thanh toán trực tiếp:</strong> Tại bàn thu ngân các cơ sở đào tạo trên toàn quốc bằng Tiền mặt hoặc Quẹt thẻ POS (Visa, Master, Napas).</li>
                  <li><strong>Trả góp học phí 0% lãi suất:</strong> Kỳ hạn 3 - 6 - 12 tháng thông qua thẻ tín dụng liên kết các ngân hàng.</li>
                </ul>
            ...
            {activeTab === 'reservation' && (
              <div className="space-y-4">
                ...
                <ul className="space-y-2 list-disc pl-5">
                  ...
                  <li><strong>Chuyển lớp / Chuyển ca:</strong> Được hỗ trợ chuyển sang lớp có cùng trình độ tại bất kỳ cơ sở nào trong hệ thống hoặc chuyển sang lớp Online.</li>
            ...
            {activeTab === 'complaint' && (
              <div className="space-y-4">
                ...
                <p>Thanhmaihsk cam kết chuẩn đầu ra đỗ chứng chỉ HSK bằng văn bản. Quy trình xử lý khiếu nại:</p>
                <ul className="space-y-2 list-disc pl-5">
                  ...
                  <li>Mọi ý kiến đóng góp về chất lượng giảng viên, cơ sở vật chất sẽ được bộ phận Chăm sóc khách hàng phản hồi và xử lý trong vòng <strong>24 giờ làm việc</strong> qua hotline 0931.715.889.</li>
                </ul>
              </div>
            )}
            ...
            {activeTab === 'privacy' && (
              <div className="space-y-4">
                ...
                <p>Thanhmaihsk cam kết bảo mật tuyệt đối dữ liệu thông tin cá nhân của học viên theo đúng quy định pháp luật Việt Nam:</p>
                <ul className="space-y-2 list-disc pl-5">
