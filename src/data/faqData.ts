...
export const faqData: FAQItem[] = [
  ...
  },
  {
    id: 'faq-03',
    category: 'chinh-sach',
    question: 'Nếu bận việc đột xuất tôi có được học bù hoặc bảo lưu khóa học không?',
    answer: 'Có! Học viên được hỗ trợ học bù miễn phí tại các lớp song song cùng trình độ trong tuần. Trường hợp có việc bận kéo dài, bạn được bảo lưu khóa học tối đa lên đến 6 tháng theo chính sách học vụ linh hoạt của trung tâm.'
  },
  {
    id: 'faq-04',
    category: 'cam-ket',
  ...
  },
  {
    id: 'faq-05',
    category: 'hoc-phi',
    question: 'Trung tâm có hỗ trợ trả góp học phí hoặc ưu đãi khi đăng ký nhóm không?',
    answer: 'Có! Trung tâm hỗ trợ chương trình trả góp học phí 0% lãi suất qua thẻ tín dụng và giảm thêm từ 5% - 10% học phí khi đăng ký theo nhóm từ 2 người trở lên hoặc đăng ký lộ trình combo dài hạn.'
  }
];
